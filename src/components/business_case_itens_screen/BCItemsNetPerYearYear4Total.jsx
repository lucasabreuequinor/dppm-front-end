...
const BCItemsNetPerYearYear4TotalStyled = styled.input`
...
`
const BCItemsNetPerYearYear4Total = () => {
  ...
  const netPerYearYear4Total = savingItemsYear4Total - costItemsYear4Total

  return <BCItemsNetPerYearYear4TotalStyled
            type="number"
            min="0"
            readOnly
            value={ (savingItems.length || costItems.length) ? netPerYearYear4Total: ""}

          />

}

export default BCItemsNetPerYearYear4Total