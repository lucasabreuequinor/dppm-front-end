...
const BCItemsProductionPerYearTotalSyled = styled.input`
...
`
const BCItemsProductionPerYearTotal = () => {
  ...
  const productionItemsTotal = productionItems.reduce((sum, item) => {
                                          return (
                                              sum + 
  ...
  return <BCItemsProductionPerYearTotalSyled
            type="number"
            min="0"
            readOnly
            value={productionItems.length ? productionItemsTotal: ""}
          />

}

export default BCItemsProductionPerYearTotal